...
//   console.log(`${text}, ${user.name ?? "гость"}`);
// }
...
//  это заняло 2 часа 53 минуты (помог учитель) значения в функции абстрактны

// const myNumber1 = 4;
// const myNumber2 = 1;

// function getNumber(num, power = 0) { // ПАРАМЕТРЫ ФУНКЦИИ!!! В скобках
//   return num ** power; // то что делает функция!!!
// }

// const result = getNumber(myNumber1, myNumber2);
// console.log(result);
...
// ОБЪЯСНИТЬ!!!!
// const num = [2, 3, 4, 5, 10];

// const getAverage = (num) => {
//   const result = num.reduce((sum, num) => sum + num, 0);

//   const lenth = num.length;

//   return result / lenth;
// };
// console.log(getAverage(num)); // почему здесь с num а не просто result
...
// ??????
// const arr = [-1, -2, -3, 1, 2, 4, 8, 10];
// const fiendNumber = arr.filter((elem) => elem > 0 && elem % 2 === 0)
// const positiveNumbers = (num) => {
//   const result = num.reduce((nfm, num) => nfm + num);
//   return result;
// };
// console.log(positiveNumbers(fiendNumber));
